...
public class Order extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = 867011653975510271L;


  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"Order\",\"namespace\":\"com.spring.kafka.avro\",\"fields\":[{\"name\":\"id\",\"type\":\"string\"},{\"name\":\"productName\",\"type\":\"string\"},{\"name\":\"quantity\",\"type\":\"int\"},{\"name\":\"ownerName\",\"type\":\"string\"}]}");
   ...
   */
  public Order(java.lang.CharSequence id, java.lang.CharSequence productName, java.lang.Integer quantity, java.lang.CharSequence ownerName) {
    this.id = id;
  ...
  public void put(int field$, java.lang.Object value$) {
    ...
    case 3: ownerName = (java.lang.CharSequence)value$; break;
    default: throw new IndexOutOfBoundsException("Invalid index: " + field$);
    }
  }
   ...
   */
  public static com.spring.kafka.avro.Order.Builder newBuilder() {
    return new com.spring.kafka.avro.Order.Builder();
  }
   ...
   * @return A new Order RecordBuilder
   */
  public static com.spring.kafka.avro.Order.Builder newBuilder(com.spring.kafka.avro.Order.Builder other) {
    if (other == null) {
      return new com.spring.kafka.avro.Order.Builder();
    } else {
      return new com.spring.kafka.avro.Order.Builder(other);
    }
  }
   ...
   * @return A new Order RecordBuilder
   */
  public static com.spring.kafka.avro.Order.Builder newBuilder(com.spring.kafka.avro.Order other) {
    if (other == null) {
      return new com.spring.kafka.avro.Order.Builder();
    } else {
      return new com.spring.kafka.avro.Order.Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<Order>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(com.spring.kafka.avro.Order.Builder other) {
      super(other);
      ...
      if (isValidValue(fields()[3], other.ownerName)) {
        this.ownerName = data().deepCopy(fields()[3].schema(), other.ownerName);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(com.spring.kafka.avro.Order other) {
      super(SCHEMA$, MODEL$);
      if (isValidValue(fields()[0], other.id)) {
        this.id = data().deepCopy(fields()[0].schema(), other.id);
    ...
    /**
      ...
      * @return This builder.
      */
    public com.spring.kafka.avro.Order.Builder setId(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.spring.kafka.avro.Order.Builder clearId() {
      id = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.spring.kafka.avro.Order.Builder setProductName(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.spring.kafka.avro.Order.Builder clearProductName() {
      productName = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.spring.kafka.avro.Order.Builder setQuantity(int value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.spring.kafka.avro.Order.Builder clearQuantity() {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.spring.kafka.avro.Order.Builder setOwnerName(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.spring.kafka.avro.Order.Builder clearOwnerName() {
      ownerName = null;
    ...
    public Order build() {
      try {
        ...
        record.ownerName = fieldSetFlags()[3] ? this.ownerName : (java.lang.CharSequence) defaultValue(fields()[3]);
        return record;
    ...
    throws java.io.IOException
  {
    ...
    if (fieldOrder == null) {
      ...
      this.ownerName = in.readString(this.ownerName instanceof Utf8 ? (Utf8)this.ownerName : null);
